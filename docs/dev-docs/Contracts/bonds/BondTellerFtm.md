<a href="https://github.com/solace-fi/solace-core/blob/main/contracts/bonds/BondTellerFtm.sol"><img src="/img/github.svg" alt="Github" width="50px"/> Source</a><br/><br/>
...
```solidity
  function setTerms(
    struct BondTellerFtm.Terms terms
  ) external
```
Sets the bond terms.
Can only be called by the current [**governor**](/docs/protocol/governance).
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
| `terms` | struct BondTellerFtm.Terms | The terms of the bond. |
